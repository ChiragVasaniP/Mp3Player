package com.sdplayer.tollsplayer.presentation.fragment;
...
import com.sdplayer.tollsplayer.data.repository.GetDownloadsListRepositoryImpl;
import com.sdplayer.tollsplayer.data.repository.PlayMusicRepositoryImpl;
import com.sdplayer.tollsplayer.databinding.FragmentListBinding;
import com.sdplayer.tollsplayer.domain.models.AudioModel;
import com.sdplayer.tollsplayer.presentation.adapter.ListAdapter;
...
//        mediaPlayer.clear();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (musicList.isEmpty()){
            binding.txtNf.setVisibility(View.VISIBLE);
            binding.conData.setVisibility(View.GONE);
        }else{
            binding.txtNf.setVisibility(View.GONE);
            binding.conData.setVisibility(View.VISIBLE);
